1. How many albums does the artists Led Zeppelin have ?

select count(*) from (select * from artists
left join albums
on artists.ArtistId = albums.ArtistId)
where Name = 'Led Zeppelin'

2. Create a list of albums titles and the unit prices for the artist "Audioslave".
...
3. Find the first and last name of any customers who does not have any invoice_items. 
...
4. Find the total price for each albums.
